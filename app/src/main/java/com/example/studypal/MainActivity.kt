...
import com.example.studypal.adapters.TaskRVVBListAdapter
import com.example.studypal.databinding.ActivityMainBinding
import com.example.studypal.models.Task
import com.example.studypal.utils.Status
import com.example.studypal.utils.StatusResult
import com.example.studypal.utils.StatusResult.*
import com.example.studypal.utils.clearEditText
import com.example.studypal.utils.hideKeyBoard
import com.example.studypal.utils.longToastShow
import com.example.studypal.utils.setupDialog
import com.example.studypal.utils.validateEditText
import com.example.studypal.viewmodels.TaskViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        isListMutableLiveData.observe(this){
            if (it){
                ...
                mainBinding.listOrGrindImg.setImageResource(R.drawable.ic_view_module)
            }else{
                mainBinding.taskRV.layoutManager = StaggeredGridLayoutManager (
                    2, LinearLayoutManager.VERTICAL
                )
                mainBinding.listOrGrindImg.setImageResource(R.drawable.ic_view_list)
            }
        }

        mainBinding.listOrGrindImg.setOnClickListener{
